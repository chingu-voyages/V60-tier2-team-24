...
function getSavedSidebarState(defaultOpen: boolean) {
  if (typeof window === "undefined") return defaultOpen

  return LocalStorage.get(SIDEBAR_STORAGE_KEY) ?? defaultOpen
}
  ...
  (
    ...
    const setOpen = React.useCallback(
      (value: boolean | ((value: boolean) => boolean)) => {
        ...
        LocalStorage.set(SIDEBAR_STORAGE_KEY, openState)
      },
      [setOpenProp, open]
    )
